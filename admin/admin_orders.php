...
.box{max-width:1200px;margin:40px auto;background:#fff;padding:30px;border-radius:14px}
...
<tr>
    ...
    <td>
        <span class="badge <?= $o['status'] ?>">
            <?= $o['status']=='paid'?'Баталгаажсан':
                ($o['status']=='cancelled'?'Цуцалсан':'Баталгаажаагүй') ?>
        </span>
    </td>
    <td><?= $o['created_at'] ?></td>
</tr>
